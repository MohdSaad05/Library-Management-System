    ...
    return (
        <div>
               <div className="col-md-10 m-auto" >
                  <h3 className='text-center bg-info p-2' style={{fontFamily:"sans-serif", color:"red"}}>Current Collection of Available Books</h3>
                  <br />
           ...
           : (
               <>
                  ...
                  <table  className='table table-bordered table-responsive-sm' style={{marginTop:"20px",border: "2px solid black" , borderCollapse: "collapse"}}>
      ...
      {currentUser.user.isAdmin && (
                      <i className= "fa fa-book" onClick={()=> console.log("okk")}></i>
                  )}
                  {!currentUser.user.isAdmin && (
...
//                   <input type="text"  className="form-control" placeholder="Look Up Books by Name"  style
//                   ={{height:"50px"}}
//                   onChange={(e) => setSearchKey(e.target.value)} value={searchKey} />
//                   <button  onClick={() => dispatch(filterBook(searchKey))} className="btn btn-primary">Lookup  </button>
//                   </div>
